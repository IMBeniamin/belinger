  ...
  <div>
    <svg fill="none" height="837" viewBox="0 0 1123 837" width="1123" xmlns="http://www.w3.org/2000/svg">
      ...
      <g id="sky" filter="url(#filter0_d)">
        <rect id="background" fill="black" height="777" rx="20" width="1063" x="30" y="26"/>
        <g id="stars">
          <path id="Vector"
        ...
        <g id="rocket">
          ...
          <g id="body-rocket">
            ...
            <g id="Group" opacity="0.1">
              <path id="Vector_20" d="M665.261 656.998H682.881L681.701 648.948H666.441L665.261 656.998Z" fill="black"
                    opacity="0.1"/>
            </g>
            ...
            <g id="Group_2" opacity="0.1">
              <path id="Vector_23" d="M587.311 656.998H604.931L603.741 648.948H588.491L587.311 656.998Z" fill="black"
                    opacity="0.1"/>
            </g>
            <path id="Vector_24"
      ...
      <defs>
        <filter id="filter0_d" color-interpolation-filters="sRGB" filterUnits="userSpaceOnUse" height="837" width="1123"
                x="0"
                y="0">
        ...
        <linearGradient id="paint0_linear" gradientUnits="userSpaceOnUse" x1="470.721" x2="470.721" y1="674.368"
                        y2="738.768">
          <stop stop-color="#E0E0E0"/>
          <stop offset="0.31" stop-color="#FCCC63"/>
          <stop offset="0.77" stop-color="#F55F44"/>
        </linearGradient>
        <linearGradient id="paint1_linear" gradientUnits="userSpaceOnUse" x1="548.051" x2="548.051" y1="674.118"
                        y2="738.518">
          <stop stop-color="#E0E0E0"/>
          <stop offset="0.31" stop-color="#FCCC63"/>
          <stop offset="0.77" stop-color="#F55F44"/>
        </linearGradient>
        <linearGradient id="paint2_linear" gradientUnits="userSpaceOnUse" x1="597.051" x2="597.051" y1="674.118"
                        y2="738.518">
          <stop stop-color="#E0E0E0"/>
          <stop offset="0.31" stop-color="#FCCC63"/>
          <stop offset="0.77" stop-color="#F55F44"/>
        </linearGradient>
        <linearGradient id="paint3_linear" gradientUnits="userSpaceOnUse" x1="674.051" x2="674.051" y1="674.118"
                        y2="738.518">
          <stop stop-color="#E0E0E0"/>
          <stop offset="0.31" stop-color="#FCCC63"/>
          <stop offset="0.77" stop-color="#F55F44"/>
