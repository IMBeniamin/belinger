...
<template>
  <div class="container">
    ...
    <p>
      At imben.it, accessible from https://imben.it/, one of our main priorities
      is the privacy of our visitors. This Privacy Policy document contains
      types of information that is collected and recorded by imben.it and how we
      use it.
    </p>
    ...
    <p>
      ...
      and/or collect in imben.it. This policy is not applicable to any
    ...
    <p>
      imben.it follows a standard procedure of using log files. These files log
    ...
    <p>
      Like any other website, imben.it uses 'cookies'. These cookies are used to
    ...
    <P
      ...
      advertising partners of imben.it.</P
    >

    <p>
      Third-party ad servers or ad networks uses technologies like cookies,
      JavaScript, or Web Beacons that are used in their respective
      advertisements and links that appear on imben.it, which are sent directly
    ...
    <p>
      Note that imben.it has no access to or control over these cookies that are
    ...
    <p>
      imben.it's Privacy Policy does not apply to other advertisers or websites.
    ...
    <p>
      imben.it does not knowingly collect any Personal Identifiable Information
